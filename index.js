...
/* Grab the vendetta global very defensively — works even if the name
   ever changes between Revenge builds                                  */
var _v = null;
try { _v = typeof vendetta !== "undefined" ? vendetta : null; } catch (e) {}

var _storage         = (_v && _v.plugin && _v.plugin.storage)                      ? _v.plugin.storage            : {};
var _registerCommand = (_v && _v.commands && _v.commands.registerCommand)           ? _v.commands.registerCommand  : null;
var _findByProps     = (_v && _v.metro && _v.metro.findByProps)                     ? _v.metro.findByProps         : null;
var _React           = (_v && _v.metro && _v.metro.common && _v.metro.common.React) ? _v.metro.common.React        : null;
